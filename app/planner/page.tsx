    ...
    <main className="rahi-planner-page relative min-h-screen overflow-hidden bg-black text-white selection:bg-teal-500 selection:text-black">
      ...
      {checkingAuth ? (
        ...
        {toast && (
          <div
            role="status"
            aria-live="polite"
            className="rahi-toast fixed left-1/2 top-4 z-50 w-[calc(100%-1.5rem)] max-w-sm -translate-x-1/2 rounded-xl border border-white/10 bg-black/80 px-4 py-2 text-sm text-white shadow-lg backdrop-blur sm:left-auto sm:right-6 sm:top-6 sm:w-auto sm:translate-x-0"
          >
            {toast}
          </div>
        )}
      ...
      {upiOpen && (
        <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/70 px-4 pb-4 sm:items-center sm:pb-0">
          <div className="w-full max-w-md max-h-[85vh] overflow-y-auto rahi-panel p-5 sm:p-6">
